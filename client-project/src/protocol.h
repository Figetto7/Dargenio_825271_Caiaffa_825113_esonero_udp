...
#define STATUS_OK 0        // Code for correct communication
#define STATUS_CITY_NOT_FOUND 1     // Code for city not found
#define STATUS_INVALID_REQUEST 2    // Code for invalid request
